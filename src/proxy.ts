...
async function handleAuth(request: NextRequest) {
    ...
    const publicRoutes = ['/', '/store', '/chat', '/c', '/api', '/auth', '/login', '/registro', '/recuperar', '/checkout', '/order', '/founding', '/privacidad', '/terminos', '/seguridad', '/robots.txt', '/sitemap.xml', '/llms.txt', '/.well-known']
