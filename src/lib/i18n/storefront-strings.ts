...
export const storefrontStrings = {
  "es-CO": {
    ...
    "store.header.search_aria": "Buscar",
    "store.header.close_search": "Cerrar búsqueda",
    ...
    "store.nudge.chip_recommend": "¿Qué me recomiendas?",
    "store.nudge.chip_shipping": "Envíos y pagos",
    "store.nudge.chip_offers": "Ver ofertas",
    "store.nudge.whatsapp_secondary": "o escríbenos por WhatsApp",
    ...
    "email.order_status.subject": "Tu pedido {{orderNumber}} · {{statusLabel}}",
    "email.order_status.heading": "Actualización de tu pedido",
    "email.order_status.body": "El estado de tu pedido {{orderNumber}} cambió a: {{statusLabel}}.",
    "email.order_status.view_order_cta": "Ver mi pedido",
    "email.order_status.footer": "Gracias por confiar en {{organizationName}}.",
    "email.order_status.label_processing": "En preparación",
    "email.order_status.label_shipped": "Enviado — va en camino",
    "email.order_status.label_delivered": "Entregado",
    "email.order_status.label_cancelled": "Cancelado",
    "store.order_status.wa_processing": "Hola {{customerName}}, estamos preparando tu pedido {{orderNumber}}. Te avisamos cuando salga. Sigue tu pedido: {{orderUrl}}",
    "store.order_status.wa_shipped": "¡Buenas noticias {{customerName}}! Tu pedido {{orderNumber}} ya va en camino. Síguelo aquí: {{orderUrl}}",
    "store.order_status.wa_delivered": "Tu pedido {{orderNumber}} fue entregado. ¡Gracias por tu compra, {{customerName}}! {{orderUrl}}",
    "store.order_status.wa_cancelled": "Hola {{customerName}}, tu pedido {{orderNumber}} fue cancelado. Si tienes dudas, respóndenos por aquí. {{orderUrl}}",
    ...
    // ========================================================================
    // Account types (CO + US)
    "dashboard.payments.account_type_ahorros": "Ahorros",
    "dashboard.payments.account_type_corriente": "Corriente",
    "dashboard.payments.account_type_checking": "Checking",
    "dashboard.payments.account_type_savings": "Savings",
    // Manual payment form labels
    "dashboard.payments.manual_card_title": "Métodos de Pago Manuales",
    "dashboard.payments.manual_card_description": "Configura transferencias bancarias y pago contra entrega",
    "dashboard.payments.bank_transfer_title": "Transferencia Bancaria",
    "dashboard.payments.bank_transfer_description": "Permite pagos por transferencia o pago instantáneo (Nequi, Zelle, etc.)",
    "dashboard.payments.bank_label": "Banco",
    "dashboard.payments.bank_select_placeholder": "Selecciona banco",
    "dashboard.payments.bank_other_option": "Otro",
    "dashboard.payments.account_type_label": "Tipo de Cuenta",
    "dashboard.payments.account_number_label": "Número de Cuenta",
    "dashboard.payments.account_number_placeholder": "000-000000-00",
    "dashboard.payments.account_holder_label": "Titular de la Cuenta",
    "dashboard.payments.account_holder_placeholder": "Nombre completo",
    "dashboard.payments.instant_payment_label_field": "Pago instantáneo (opcional)",
    "dashboard.payments.instant_payment_label_placeholder": "Nequi, Zelle, CashApp, PayPal...",
    "dashboard.payments.instant_payment_value_label": "Identificador",
    "dashboard.payments.instant_payment_value_placeholder": "Email, teléfono o handle",
    "dashboard.payments.instant_payment_help": "Servicio adicional de pago instantáneo (opcional). El cliente verá esta info en el checkout.",
    "dashboard.payments.instructions_label": "Instrucciones adicionales (opcional)",
    "dashboard.payments.instructions_placeholder": "Ejemplo: Envía el comprobante por WhatsApp al confirmar la transferencia. Procesamos pedidos en 2 horas hábiles.",
    "dashboard.payments.instructions_help": "Texto libre que se mostrará al cliente en el checkout cuando elija pago manual.",
    "dashboard.payments.cod_title": "Pago Contra Entrega",
    "dashboard.payments.cod_description": "El cliente paga cuando recibe el producto",
    "dashboard.payments.cod_additional_cost_label": "Costo Adicional",
    "dashboard.payments.cod_additional_cost_help": "Costo adicional por pago contra entrega (en la moneda de tu tienda).",
    "dashboard.payments.save_btn": "Guardar Configuración",
    "dashboard.payments.saving_btn": "Guardando...",
    "dashboard.payments.toast_save_success": "Configuración guardada correctamente",
    "dashboard.payments.toast_save_error": "Error al guardar",
  },
  "en-US": {
    ...
    "store.header.search_aria": "Search",
    "store.header.close_search": "Close search",
    ...
    "store.nudge.chip_recommend": "What do you recommend?",
    "store.nudge.chip_shipping": "Shipping & payment",
    "store.nudge.chip_offers": "See deals",
    "store.nudge.whatsapp_secondary": "or message us on WhatsApp",
    ...
    "email.order_status.subject": "Your order {{orderNumber}} · {{statusLabel}}",
    "email.order_status.heading": "Order update",
    "email.order_status.body": "Your order {{orderNumber}} status changed to: {{statusLabel}}.",
    "email.order_status.view_order_cta": "View my order",
    "email.order_status.footer": "Thank you for choosing {{organizationName}}.",
    "email.order_status.label_processing": "In preparation",
    "email.order_status.label_shipped": "Shipped — on its way",
    "email.order_status.label_delivered": "Delivered",
    "email.order_status.label_cancelled": "Cancelled",
    "store.order_status.wa_processing": "Hi {{customerName}}, we're preparing your order {{orderNumber}}. We'll let you know when it ships. Track it: {{orderUrl}}",
    "store.order_status.wa_shipped": "Good news {{customerName}}! Your order {{orderNumber}} is on its way. Track it here: {{orderUrl}}",
    "store.order_status.wa_delivered": "Your order {{orderNumber}} was delivered. Thanks for your purchase, {{customerName}}! {{orderUrl}}",
    "store.order_status.wa_cancelled": "Hi {{customerName}}, your order {{orderNumber}} was cancelled. If you have any questions, reply here. {{orderUrl}}",
    ...
    // ========================================================================
    // Account types (CO + US)
    "dashboard.payments.account_type_ahorros": "Savings (CO)",
    "dashboard.payments.account_type_corriente": "Checking (CO)",
    "dashboard.payments.account_type_checking": "Checking",
    "dashboard.payments.account_type_savings": "Savings",
    // Manual payment form labels
    "dashboard.payments.manual_card_title": "Manual Payment Methods",
    "dashboard.payments.manual_card_description": "Configure bank transfers and cash on delivery",
    "dashboard.payments.bank_transfer_title": "Bank Transfer",
    "dashboard.payments.bank_transfer_description": "Allow payments via bank transfer or instant payment (Zelle, CashApp, etc.)",
    "dashboard.payments.bank_label": "Bank",
    "dashboard.payments.bank_select_placeholder": "Select bank",
    "dashboard.payments.bank_other_option": "Other",
    "dashboard.payments.account_type_label": "Account Type",
    "dashboard.payments.account_number_label": "Account Number",
    "dashboard.payments.account_number_placeholder": "000-000000-00",
    "dashboard.payments.account_holder_label": "Account Holder",
    "dashboard.payments.account_holder_placeholder": "Full name",
    "dashboard.payments.instant_payment_label_field": "Instant payment (optional)",
    "dashboard.payments.instant_payment_label_placeholder": "Zelle, CashApp, PayPal, Nequi...",
    "dashboard.payments.instant_payment_value_label": "Identifier",
    "dashboard.payments.instant_payment_value_placeholder": "Email, phone, or handle",
    "dashboard.payments.instant_payment_help": "Additional instant payment service (optional). Customers will see this info at checkout.",
    "dashboard.payments.instructions_label": "Additional instructions (optional)",
    "dashboard.payments.instructions_placeholder": "Example: Send the receipt via WhatsApp once you confirm the transfer. We process orders within 2 business hours.",
    "dashboard.payments.instructions_help": "Free text shown to customers at checkout when they choose manual payment.",
    "dashboard.payments.cod_title": "Cash on Delivery",
    "dashboard.payments.cod_description": "Customer pays when receiving the product",
    "dashboard.payments.cod_additional_cost_label": "Additional Cost",
    "dashboard.payments.cod_additional_cost_help": "Additional cost for cash on delivery (in your store's currency).",
    "dashboard.payments.save_btn": "Save Configuration",
    "dashboard.payments.saving_btn": "Saving...",
    "dashboard.payments.toast_save_success": "Configuration saved successfully",
    "dashboard.payments.toast_save_error": "Error saving",
  },
