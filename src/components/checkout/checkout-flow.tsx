...
export function CheckoutFlow({ slug, sourceChannel, chatId, onCancel, variant = "page" }: CheckoutFlowProps) {
    ...
    // Cargar configuración de envío, gateways y métodos manuales al montar/cambiar slug.
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    "flex-1",
                    variant === "modal" ? "overflow-y-auto px-6 pb-6 pr-4 -mr-2" : "px-1",
                )}
            >
                {step === 'contact' && (
                            ...
                            <div className="space-y-2">
                                {appliedCoupon ? (
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700">
                                        ...
                                        <button onClick={handleRemoveCoupon} className="text-red-500 hover:text-red-700 p-1" aria-label="Quitar cupón">
                ...
                {step === 'success' && (
                    <div className="py-8 flex flex-col items-center text-center space-y-4">
                        ...
                        <Button onClick={handleSuccessCta} className="mt-4 min-w-[200px]">
                            Ver Pedido
                        </Button>
                    </div>
                )}
