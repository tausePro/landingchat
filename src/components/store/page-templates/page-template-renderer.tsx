...
export function PageTemplateRenderer({
    ...
    switch (content.type) {
        case 'faq':
            return <FAQTemplate content={content} organizationSlug={organizationSlug} primaryColor={primaryColor} />

        case 'legal':
            return <LegalTemplate content={content} organizationSlug={organizationSlug} primaryColor={primaryColor} />

        case 'about':
            return <AboutTemplate content={content} organizationSlug={organizationSlug} primaryColor={primaryColor} />
