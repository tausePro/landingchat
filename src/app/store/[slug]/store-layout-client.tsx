        ...
        <div className="min-h-screen bg-white text-slate-900" style={{ fontFamily: fontFamily }}>
            ...
            {organization.settings?.whatsapp?.phone && (
                <a
                    ...
                    className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg shadow-green-500/30 transition-transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-300"
