        ...
        <div className="flex min-h-screen w-full bg-slate-50 dark:bg-slate-950">
            ...
            <aside className="fixed inset-y-0 left-0 z-50 w-64 border-r border-indigo-900/10 bg-[#1E1B4B] text-white shadow-xl">
                ...
                <nav className="flex flex-col gap-1 p-4">
                    ...
                    <Link href="/admin/settings/meta-whatsapp" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-colors">
